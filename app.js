...
function hbPlayerTopTwoLinesV7D(){
  const room = (
  ...
  const wanted = `<div class="playerTopRoom">${esc(room)}</div><div class="playerTopName">${esc(name)}</div>`;
  if(pill.innerHTML !== wanted){
    pill.innerHTML = wanted;
  }
}
...
setTimeout(hbPlayerTopTwoLinesV7D, 300);
setTimeout(hbPlayerTopTwoLinesV7D, 1000);
setInterval(hbPlayerTopTwoLinesV7D, 2000);
...
setTimeout(hbPlainRoomCodeTopV7E, 100);
setTimeout(hbPlainRoomCodeTopV7E, 700);
setTimeout(hbPlainRoomCodeTopV7E, 1500);
setInterval(hbPlainRoomCodeTopV7E, 2000);
