...
(function(){
  ...
  function bb36ForceReplaceOldPicker(){
    ["hostPickerArea","dashPickerArea","playerPickerArea"].forEach(id=>{
      ...
      const looksOld = html.includes("dashDisco") || html.includes("discoIcon") || html.includes("Disco") || html.includes("Discobal kiest") || html.includes("Vos kiest een kleur") || html.includes("kiest een kleur...");
